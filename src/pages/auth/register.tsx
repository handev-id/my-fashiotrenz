    ...
    <Center h="100vh" bg={Colors.fourthirty} color="white" py={10}>
      <Card bg="white" w={350} mx={2} py={5}>
        <CardBody>
          ...
          >
            {isError && "Email sudah terdaftar"}
          </p>
          <form onSubmit={handleSubmit(submitUser)}>
            <VStack>
              <Text fontWeight={700} color="gray.600" marginRight="auto">
                Email
              </Text>
              <Input
                {...register("email")}
                placeholder="Email"
                focusBorderColor={isError ? "crimson" : Colors.secondary}
                isInvalid={isError}
              />
              <Text
                fontWeight={700}
